...
public:
    ...
    QLabel *label;
    QPushButton *btnCoolantFlood;
    QPushButton *btnCoolantMist;
    QPushButton *btnCoolantDisable;
    ...
    void setupUi(QMainWindow *win_snail_windows)
    {
        if (win_snail_windows->objectName().isEmpty())
            win_snail_windows->setObjectName(QString::fromUtf8("win_snail_windows"));
        win_snail_windows->resize(1646, 964);
        win_snail_windows->setAcceptDrops(true);
        win_snail_windows->setWindowTitle(QString::fromUtf8("win_snail"));
        QIcon icon;
        icon.addFile(QString::fromUtf8(":/images/candle_256.png"), QSize(), QIcon::Normal, QIcon::Off);
        win_snail_windows->setWindowIcon(icon);
        win_snail_windows->setStyleSheet(QString::fromUtf8("/*QWidget {\n"
"	font-size: 9pt;\n"
"}*/\n"
"\n"
...
"padding-right: 8;"));
        ...
        cboCoord1->setMinimumSize(QSize(60, 0));
        ...
        cboCoord2->setMinimumSize(QSize(60, 0));
        ...
        txtCoordX->setMaximumSize(QSize(56, 16777215));
        ...
        txtCoordY->setMaximumSize(QSize(56, 16777215));
        ...
        txtCoordZ->setMaximumSize(QSize(56, 16777215));
        ...
        horizontalLayout_36->setContentsMargins(10, -1, 10, 0);
        btnClearCoord = new QPushButton(tab_2);
        btnClearCoord->setObjectName(QString::fromUtf8("btnClearCoord"));

        horizontalLayout_36->addWidget(btnClearCoord);
        ...
        verticalLayout_12->addLayout(horizontalLayout_36);
        ...
        verticalLayoutWidget->setGeometry(QRect(10, 10, 581, 181));
        ...
        horizontalLayout_37->setContentsMargins(10, -1, 10, -1);
        label = new QLabel(verticalLayoutWidget);
        label->setObjectName(QString::fromUtf8("label"));
        label->setFont(font);

        horizontalLayout_37->addWidget(label);

        btnCoolantFlood = new QPushButton(verticalLayoutWidget);
        btnCoolantFlood->setObjectName(QString::fromUtf8("btnCoolantFlood"));

        horizontalLayout_37->addWidget(btnCoolantFlood);

        btnCoolantMist = new QPushButton(verticalLayoutWidget);
        btnCoolantMist->setObjectName(QString::fromUtf8("btnCoolantMist"));

        horizontalLayout_37->addWidget(btnCoolantMist);

        btnCoolantDisable = new QPushButton(verticalLayoutWidget);
        btnCoolantDisable->setObjectName(QString::fromUtf8("btnCoolantDisable"));

        horizontalLayout_37->addWidget(btnCoolantDisable);
        ...
        workCoordsLabel = new QLabel(grpState);
        workCoordsLabel->setObjectName(QString::fromUtf8("workCoordsLabel"));
        workCoordsLabel->setFont(font);

        horizontalLayout_9->addWidget(workCoordsLabel);
        ...
        machineCoordslabel = new QLabel(grpState);
        machineCoordslabel->setObjectName(QString::fromUtf8("machineCoordslabel"));
        machineCoordslabel->setFont(font);

        horizontalLayout_10->addWidget(machineCoordslabel);
        ...
        QIcon icon16;
        icon16.addFile(QString::fromUtf8(":/images/home.png"), QSize(), QIcon::Normal, QIcon::Off);
        cmdHome->setIcon(icon16);
        ...
        QIcon icon17;
        icon17.addFile(QString::fromUtf8(":/images/axis_zero.png"), QSize(), QIcon::Normal, QIcon::Off);
        cmdZeroY->setIcon(icon17);
        ...
        QIcon icon18;
        icon18.addFile(QString::fromUtf8(":/images/origin.png"), QSize(), QIcon::Normal, QIcon::Off);
        cmdRestoreOrigin->setIcon(icon18);
        ...
        QIcon icon19;
        icon19.addFile(QString::fromUtf8(":/images/safe_z.png"), QSize(), QIcon::Normal, QIcon::Off);
        cmdSafePosition->setIcon(icon19);
        ...
        QIcon icon20;
        icon20.addFile(QString::fromUtf8(":/images/zero_z.png"), QSize(), QIcon::Normal, QIcon::Off);
        cmdZeroZ->setIcon(icon20);
        ...
        QIcon icon21;
        icon21.addFile(QString::fromUtf8(":/images/unlock.png"), QSize(), QIcon::Normal, QIcon::Off);
        cmdUnlock->setIcon(icon21);
        ...
        QIcon icon22;
        icon22.addFile(QString::fromUtf8(":/images/search_for_z.png"), QSize(), QIcon::Normal, QIcon::Off);
        cmdTouch->setIcon(icon22);
...
"}"));
        ...
        scrollAreaWidgetContents->setGeometry(QRect(0, 0, 378, 494));
        ...
        QIcon icon23;
        icon23.addFile(QString::fromUtf8(":/images/1401561986_chevron-left.png"), QSize(), QIcon::Normal, QIcon::Off);
        cmdXMinus->setIcon(icon23);
        ...
        QIcon icon24;
        icon24.addFile(QString::fromUtf8(":/images/1401562173_chevron-down.png"), QSize(), QIcon::Normal, QIcon::Off);
        cmdYMinus->setIcon(icon24);
        ...
        QIcon icon25;
        icon25.addFile(QString::fromUtf8(":/images/1401562173_chevron-right.png"), QSize(), QIcon::Normal, QIcon::Off);
        cmdXPlus->setIcon(icon25);
        ...
        QIcon icon26;
        icon26.addFile(QString::fromUtf8(":/images/1401562173_chevron-up.png"), QSize(), QIcon::Normal, QIcon::Off);
        cmdYPlus->setIcon(icon26);
        ...
        QIcon icon28;
        icon28.addFile(QString::fromUtf8(":/images/1401562699_icon-arrow-down-b.png"), QSize(), QIcon::Normal, QIcon::Off);
        cmdZMinus->setIcon(icon28);
        ...
        QIcon icon29;
        icon29.addFile(QString::fromUtf8(":/images/brake.png"), QSize(), QIcon::Normal, QIcon::Off);
        cmdStop->setIcon(icon29);
        ...
        QIcon icon30;
        icon30.addFile(QString::fromUtf8(":/images/cutter.png"), QSize(), QIcon::Normal, QIcon::Off);
        cmdSpindle->setIcon(icon30);
        ...
        win_snail_windows->setCentralWidget(centralWidget);
        menuBar = new QMenuBar(win_snail_windows);
        menuBar->setObjectName(QString::fromUtf8("menuBar"));
        menuBar->setGeometry(QRect(0, 0, 1646, 21));
        ...
        win_snail_windows->setMenuBar(menuBar);
        ...
        retranslateUi(win_snail_windows);
        ...
        QMetaObject::connectSlotsByName(win_snail_windows);
    } // setupUi

    void retranslateUi(QMainWindow *win_snail_windows)
    {
        actFileOpen->setText(QCoreApplication::translate("win_snail_windows", "&Open", nullptr));
#if QT_CONFIG(shortcut)
        actFileOpen->setShortcut(QCoreApplication::translate("win_snail_windows", "Ctrl+O", nullptr));
#endif // QT_CONFIG(shortcut)
        actFileExit->setText(QCoreApplication::translate("win_snail_windows", "E&xit", nullptr));
        actServiceSettings->setText(QCoreApplication::translate("win_snail_windows", "&Settings", nullptr));
        actFileNew->setText(QCoreApplication::translate("win_snail_windows", "&New", nullptr));
#if QT_CONFIG(shortcut)
        actFileNew->setShortcut(QCoreApplication::translate("win_snail_windows", "Ctrl+N", nullptr));
#endif // QT_CONFIG(shortcut)
        actFileSave->setText(QCoreApplication::translate("win_snail_windows", "&Save", nullptr));
#if QT_CONFIG(shortcut)
        actFileSave->setShortcut(QCoreApplication::translate("win_snail_windows", "Ctrl+S", nullptr));
#endif // QT_CONFIG(shortcut)
        actFileSaveAs->setText(QCoreApplication::translate("win_snail_windows", "Save &as...", nullptr));
        actAbout->setText(QCoreApplication::translate("win_snail_windows", "&About", nullptr));
        actRecentClear->setText(QCoreApplication::translate("win_snail_windows", "&Clear", nullptr));
        actFileSaveTransformedAs->setText(QCoreApplication::translate("win_snail_windows", "Save &transformed as...", nullptr));
        actionMachine_settings->setText(QCoreApplication::translate("win_snail_windows", "&Machine settings", nullptr));
        actionHard_Reset->setText(QCoreApplication::translate("win_snail_windows", "&Hard Reset", nullptr));
#if QT_CONFIG(tooltip)
        actionHard_Reset->setToolTip(QCoreApplication::translate("win_snail_windows", "<html><head/><body><p>Perform Hard Reset of machine control</p></body></html>", nullptr));
#endif // QT_CONFIG(tooltip)
        actionSave_TLS_Position->setText(QCoreApplication::translate("win_snail_windows", "&Save TLS Position", nullptr));
        actionSet_TLS_Position->setText(QCoreApplication::translate("win_snail_windows", "S&et TLS Position", nullptr));
        actionDisable_Stepper->setText(QCoreApplication::translate("win_snail_windows", "&Disable Stepper", nullptr));
#if QT_CONFIG(tooltip)
        cmdIsometric->setToolTip(QCoreApplication::translate("win_snail_windows", "Isometric view", nullptr));
#endif // QT_CONFIG(tooltip)
        cmdIsometric->setText(QString());
        label_3->setText(QCoreApplication::translate("win_snail_windows", "Protocol:", nullptr));
        comboProtocol->setCurrentText(QString());
        label_4->setText(QCoreApplication::translate("win_snail_windows", "Interface:", nullptr));
        btnReload->setText(QString());
        label_21->setText(QCoreApplication::translate("win_snail_windows", "Baud", nullptr));
        btnConnect->setText(QCoreApplication::translate("win_snail_windows", "Connect", nullptr));
        btnHandwheel->setText(QCoreApplication::translate("win_snail_windows", "MPG", nullptr));
#if QT_CONFIG(tooltip)
        cmdTop->setToolTip(QCoreApplication::translate("win_snail_windows", "Top view", nullptr));
#endif // QT_CONFIG(tooltip)
        cmdTop->setText(QString());
#if QT_CONFIG(tooltip)
        cmdFront->setToolTip(QCoreApplication::translate("win_snail_windows", "Front view", nullptr));
#endif // QT_CONFIG(tooltip)
        cmdFront->setText(QString());
#if QT_CONFIG(tooltip)
        cmdLeft->setToolTip(QCoreApplication::translate("win_snail_windows", "Left view", nullptr));
#endif // QT_CONFIG(tooltip)
        cmdLeft->setText(QString());
#if QT_CONFIG(tooltip)
        cmdFit->setToolTip(QCoreApplication::translate("win_snail_windows", "Fit", nullptr));
#endif // QT_CONFIG(tooltip)
        cmdFit->setText(QString());
        grpConsole->setTitle(QCoreApplication::translate("win_snail_windows", "Console", nullptr));
#if QT_CONFIG(tooltip)
        cmdCommandSend->setToolTip(QCoreApplication::translate("win_snail_windows", "Send command", nullptr));
#endif // QT_CONFIG(tooltip)
#if QT_CONFIG(tooltip)
        cmdClearConsole->setToolTip(QCoreApplication::translate("win_snail_windows", "Clear console", nullptr));
#endif // QT_CONFIG(tooltip)
        tabWidget->setTabText(tabWidget->indexOf(tab), QCoreApplication::translate("win_snail_windows", "Console", nullptr));
        label_31->setText(QCoreApplication::translate("win_snail_windows", "Coordinate System", nullptr));
        cboCoord1->setItemText(0, QCoreApplication::translate("win_snail_windows", "G54", nullptr));
        cboCoord1->setItemText(1, QCoreApplication::translate("win_snail_windows", "G55", nullptr));
        cboCoord1->setItemText(2, QCoreApplication::translate("win_snail_windows", "G56", nullptr));
        cboCoord1->setItemText(3, QCoreApplication::translate("win_snail_windows", "G57", nullptr));
        cboCoord1->setItemText(4, QCoreApplication::translate("win_snail_windows", "G58", nullptr));
        cboCoord1->setItemText(5, QCoreApplication::translate("win_snail_windows", "G59", nullptr));

        btnSetCoord->setText(QCoreApplication::translate("win_snail_windows", "Load", nullptr));
        label_23->setText(QCoreApplication::translate("win_snail_windows", "G10 L20 P", nullptr));
        cboCoord2->setItemText(0, QCoreApplication::translate("win_snail_windows", "G54", nullptr));
        cboCoord2->setItemText(1, QCoreApplication::translate("win_snail_windows", "G55", nullptr));
        cboCoord2->setItemText(2, QCoreApplication::translate("win_snail_windows", "G56", nullptr));
        cboCoord2->setItemText(3, QCoreApplication::translate("win_snail_windows", "G57", nullptr));
        cboCoord2->setItemText(4, QCoreApplication::translate("win_snail_windows", "G58", nullptr));
        cboCoord2->setItemText(5, QCoreApplication::translate("win_snail_windows", "G59", nullptr));

        label_24->setText(QCoreApplication::translate("win_snail_windows", "X", nullptr));
        txtCoordX->setText(QCoreApplication::translate("win_snail_windows", "0", nullptr));
        label_25->setText(QCoreApplication::translate("win_snail_windows", "Y", nullptr));
        txtCoordY->setText(QCoreApplication::translate("win_snail_windows", "0", nullptr));
        label_26->setText(QCoreApplication::translate("win_snail_windows", "Z", nullptr));
        txtCoordZ->setText(QCoreApplication::translate("win_snail_windows", "0", nullptr));
        btnSaveCoord->setText(QCoreApplication::translate("win_snail_windows", "Set", nullptr));
#if QT_CONFIG(tooltip)
        btnClearCoord->setToolTip(QCoreApplication::translate("win_snail_windows", "Reset all coord systems", nullptr));
#endif // QT_CONFIG(tooltip)
        btnClearCoord->setText(QCoreApplication::translate("win_snail_windows", "Reset", nullptr));
        tabWidget->setTabText(tabWidget->indexOf(tab_2), QCoreApplication::translate("win_snail_windows", "Coord System", nullptr));
        grpUserCommands->setTitle(QCoreApplication::translate("win_snail_windows", "User commands", nullptr));
#if QT_CONFIG(tooltip)
        cmdUser1->setToolTip(QCoreApplication::translate("win_snail_windows", "Spindle on/off", nullptr));
#endif // QT_CONFIG(tooltip)
#if QT_CONFIG(tooltip)
        cmdUser3->setToolTip(QCoreApplication::translate("win_snail_windows", "Spindle on/off", nullptr));
#endif // QT_CONFIG(tooltip)
#if QT_CONFIG(tooltip)
        cmdUser2->setToolTip(QCoreApplication::translate("win_snail_windows", "Spindle on/off", nullptr));
#endif // QT_CONFIG(tooltip)
#if QT_CONFIG(tooltip)
        cmdUser0->setToolTip(QCoreApplication::translate("win_snail_windows", "Spindle on/off", nullptr));
#endif // QT_CONFIG(tooltip)
        tabWidget->setTabText(tabWidget->indexOf(tab_3), QCoreApplication::translate("win_snail_windows", "User Cmd", nullptr));
        grpOverriding->setTitle(QCoreApplication::translate("win_snail_windows", "Overriding", nullptr));
        tabWidget->setTabText(tabWidget->indexOf(tab_7), QCoreApplication::translate("win_snail_windows", "Override", nullptr));
        label->setText(QCoreApplication::translate("win_snail_windows", "Coolant:", nullptr));
        btnCoolantFlood->setText(QCoreApplication::translate("win_snail_windows", "Flood", nullptr));
        btnCoolantMist->setText(QCoreApplication::translate("win_snail_windows", "Mist", nullptr));
        btnCoolantDisable->setText(QCoreApplication::translate("win_snail_windows", "Disable", nullptr));
        tabWidget->setTabText(tabWidget->indexOf(tab_4), QCoreApplication::translate("win_snail_windows", "Misc", nullptr));
        grpHeightMapSettings->setTitle(QCoreApplication::translate("win_snail_windows", "Heightmap settings", nullptr));
        label_5->setText(QCoreApplication::translate("win_snail_windows", "Border:", nullptr));
        label_6->setText(QCoreApplication::translate("win_snail_windows", "X:", nullptr));
        label_9->setText(QCoreApplication::translate("win_snail_windows", "H:", nullptr));
        label_7->setText(QCoreApplication::translate("win_snail_windows", "Y:", nullptr));
        label_8->setText(QCoreApplication::translate("win_snail_windows", "W:", nullptr));
        chkHeightMapBorderShow->setText(QCoreApplication::translate("win_snail_windows", "Show border", nullptr));
        cmdHeightMapBorderAuto->setText(QCoreApplication::translate("win_snail_windows", "Auto", nullptr));
        label_10->setText(QCoreApplication::translate("win_snail_windows", "Probe grid:", nullptr));
        label_12->setText(QCoreApplication::translate("win_snail_windows", "X:", nullptr));
        label_11->setText(QCoreApplication::translate("win_snail_windows", "Zb:", nullptr));
        label_13->setText(QCoreApplication::translate("win_snail_windows", "Y:", nullptr));
        label_14->setText(QCoreApplication::translate("win_snail_windows", "Zt:", nullptr));
        chkHeightMapGridShow->setText(QCoreApplication::translate("win_snail_windows", "Show grid", nullptr));
        label_16->setText(QCoreApplication::translate("win_snail_windows", "Interpolation grid:", nullptr));
        label_19->setText(QCoreApplication::translate("win_snail_windows", "Y:", nullptr));
        label_18->setText(QCoreApplication::translate("win_snail_windows", "X:", nullptr));
        label_17->setText(QCoreApplication::translate("win_snail_windows", "Type:", nullptr));
        cboHeightMapInterpolationType->setItemText(0, QCoreApplication::translate("win_snail_windows", "Bicubic", nullptr));

        chkHeightMapInterpolationShow->setText(QCoreApplication::translate("win_snail_windows", "Show", nullptr));
        chkTestMode->setText(QCoreApplication::translate("win_snail_windows", "Check mode", nullptr));
        chkAutoScroll->setText(QCoreApplication::translate("win_snail_windows", "Autoscroll", nullptr));
        cmdFileSend->setText(QCoreApplication::translate("win_snail_windows", "Send", nullptr));
        cmdFilePause->setText(QCoreApplication::translate("win_snail_windows", "Pause", nullptr));
        cmdFileAbort->setText(QCoreApplication::translate("win_snail_windows", "Stop", nullptr));
        cmdFileReset->setText(QCoreApplication::translate("win_snail_windows", "Reset", nullptr));
        cmdFileOpen->setText(QCoreApplication::translate("win_snail_windows", "Open", nullptr));
        grpState->setTitle(QCoreApplication::translate("win_snail_windows", "State", nullptr));
        workCoordsLabel->setText(QCoreApplication::translate("win_snail_windows", "Work Coordinates:", nullptr));
        machineCoordslabel->setText(QCoreApplication::translate("win_snail_windows", "Machine Coordinates:", nullptr));
#if QT_CONFIG(tooltip)
        txtMPosX->setToolTip(QCoreApplication::translate("win_snail_windows", "X", nullptr));
#endif // QT_CONFIG(tooltip)
        txtMPosX->setText(QCoreApplication::translate("win_snail_windows", "0", nullptr));
#if QT_CONFIG(tooltip)
        txtMPosY->setToolTip(QCoreApplication::translate("win_snail_windows", "Y", nullptr));
#endif // QT_CONFIG(tooltip)
        txtMPosY->setText(QCoreApplication::translate("win_snail_windows", "0", nullptr));
#if QT_CONFIG(tooltip)
        txtMPosZ->setToolTip(QCoreApplication::translate("win_snail_windows", "Z", nullptr));
#endif // QT_CONFIG(tooltip)
        txtMPosZ->setText(QCoreApplication::translate("win_snail_windows", "0", nullptr));
#if QT_CONFIG(tooltip)
        txtMPosA->setToolTip(QCoreApplication::translate("win_snail_windows", "A axis", nullptr));
#endif // QT_CONFIG(tooltip)
        txtMPosA->setText(QCoreApplication::translate("win_snail_windows", "0", nullptr));
#if QT_CONFIG(tooltip)
        txtMPosB->setToolTip(QCoreApplication::translate("win_snail_windows", "B axis", nullptr));
#endif // QT_CONFIG(tooltip)
        txtMPosB->setText(QCoreApplication::translate("win_snail_windows", "0", nullptr));
        Label->setText(QCoreApplication::translate("win_snail_windows", "Status:", nullptr));
        txtStatus->setProperty("status", QVariant(QString()));
        cmdReset->setText(QCoreApplication::translate("win_snail_windows", "Reset", nullptr));
        grpControl->setTitle(QCoreApplication::translate("win_snail_windows", "Control", nullptr));
        cmdHome->setText(QCoreApplication::translate("win_snail_windows", "HOME", nullptr));
        cmdZeroY->setText(QCoreApplication::translate("win_snail_windows", "Zero Y", nullptr));
        cmdRestoreOrigin->setText(QCoreApplication::translate("win_snail_windows", "Origin", nullptr));
        cmdSafePosition->setText(QCoreApplication::translate("win_snail_windows", "Safe", nullptr));
        cmdZeroZ->setText(QCoreApplication::translate("win_snail_windows", "Zero Z", nullptr));
        cmdUnlock->setText(QCoreApplication::translate("win_snail_windows", "Unlock", nullptr));
        cmdTouch->setText(QCoreApplication::translate("win_snail_windows", "Probe", nullptr));
        cmdZeroX->setText(QCoreApplication::translate("win_snail_windows", "Zero X", nullptr));
        grpJog->setTitle(QCoreApplication::translate("win_snail_windows", "Jog", nullptr));
#if QT_CONFIG(tooltip)
        cmdXMinus->setToolTip(QCoreApplication::translate("win_snail_windows", "X-", nullptr));
#endif // QT_CONFIG(tooltip)
        cmdXMinus->setText(QCoreApplication::translate("win_snail_windows", "...", nullptr));
#if QT_CONFIG(tooltip)
        cmdYMinus->setToolTip(QCoreApplication::translate("win_snail_windows", "Y-", nullptr));
#endif // QT_CONFIG(tooltip)
        cmdYMinus->setText(QString());
#if QT_CONFIG(tooltip)
        cmdXPlus->setToolTip(QCoreApplication::translate("win_snail_windows", "X+", nullptr));
#endif // QT_CONFIG(tooltip)
        cmdXPlus->setText(QString());
#if QT_CONFIG(tooltip)
        cmdYPlus->setToolTip(QCoreApplication::translate("win_snail_windows", "Y+", nullptr));
#endif // QT_CONFIG(tooltip)
        cmdYPlus->setText(QString());
#if QT_CONFIG(tooltip)
        cmdZPlus->setToolTip(QCoreApplication::translate("win_snail_windows", "Z+", nullptr));
#endif // QT_CONFIG(tooltip)
        cmdZPlus->setText(QString());
#if QT_CONFIG(tooltip)
        cmdZMinus->setToolTip(QCoreApplication::translate("win_snail_windows", "Z-", nullptr));
#endif // QT_CONFIG(tooltip)
        cmdZMinus->setText(QString());
#if QT_CONFIG(tooltip)
        cmdStop->setToolTip(QCoreApplication::translate("win_snail_windows", "Stop", nullptr));
#endif // QT_CONFIG(tooltip)
        cmdStop->setText(QString());
        cboJogStep->setItemText(0, QCoreApplication::translate("win_snail_windows", "Continuously", nullptr));
        cboJogStep->setItemText(1, QCoreApplication::translate("win_snail_windows", "0.01", nullptr));
        cboJogStep->setItemText(2, QCoreApplication::translate("win_snail_windows", "0.1", nullptr));
        cboJogStep->setItemText(3, QCoreApplication::translate("win_snail_windows", "1", nullptr));
        cboJogStep->setItemText(4, QCoreApplication::translate("win_snail_windows", "2", nullptr));
        cboJogStep->setItemText(5, QCoreApplication::translate("win_snail_windows", "5", nullptr));
        cboJogStep->setItemText(6, QCoreApplication::translate("win_snail_windows", "10", nullptr));
        cboJogStep->setItemText(7, QCoreApplication::translate("win_snail_windows", "20", nullptr));
        cboJogStep->setItemText(8, QCoreApplication::translate("win_snail_windows", "50", nullptr));
        cboJogStep->setItemText(9, QCoreApplication::translate("win_snail_windows", "100", nullptr));
        cboJogStep->setItemText(10, QCoreApplication::translate("win_snail_windows", "200", nullptr));

        label_20->setText(QCoreApplication::translate("win_snail_windows", "Step:", nullptr));
        label_22->setText(QCoreApplication::translate("win_snail_windows", "Feed:", nullptr));
        cboJogFeed->setItemText(0, QCoreApplication::translate("win_snail_windows", "10", nullptr));
        cboJogFeed->setItemText(1, QCoreApplication::translate("win_snail_windows", "20", nullptr));
        cboJogFeed->setItemText(2, QCoreApplication::translate("win_snail_windows", "50", nullptr));
        cboJogFeed->setItemText(3, QCoreApplication::translate("win_snail_windows", "100", nullptr));
        cboJogFeed->setItemText(4, QCoreApplication::translate("win_snail_windows", "200", nullptr));
        cboJogFeed->setItemText(5, QCoreApplication::translate("win_snail_windows", "500", nullptr));
        cboJogFeed->setItemText(6, QCoreApplication::translate("win_snail_windows", "1000", nullptr));
        cboJogFeed->setItemText(7, QCoreApplication::translate("win_snail_windows", "2000", nullptr));

        chkKeyboardControl->setText(QCoreApplication::translate("win_snail_windows", "Keyboard control", nullptr));
        grpSpindle->setTitle(QCoreApplication::translate("win_snail_windows", "Spindle", nullptr));
#if QT_CONFIG(tooltip)
        cmdSpindle->setToolTip(QCoreApplication::translate("win_snail_windows", "Spindle on/off", nullptr));
#endif // QT_CONFIG(tooltip)
        grpHeightMap->setTitle(QCoreApplication::translate("win_snail_windows", "Heightmap", nullptr));
        chkHeightMapUse->setText(QCoreApplication::translate("win_snail_windows", "Use heightmap", nullptr));
        label_15->setText(QCoreApplication::translate("win_snail_windows", "Map:", nullptr));
        txtHeightMap->setText(QString());
        txtHeightMap->setPlaceholderText(QCoreApplication::translate("win_snail_windows", "Absent", nullptr));
        cmdHeightMapCreate->setText(QCoreApplication::translate("win_snail_windows", "Create", nullptr));
        cmdHeightMapLoad->setText(QCoreApplication::translate("win_snail_windows", "Open", nullptr));
        cmdHeightMapMode->setText(QCoreApplication::translate("win_snail_windows", "Edit mode", nullptr));
        mnuFile->setTitle(QCoreApplication::translate("win_snail_windows", "&File", nullptr));
        mnuRecent->setTitle(QCoreApplication::translate("win_snail_windows", "&Recent files", nullptr));
        mnuService->setTitle(QCoreApplication::translate("win_snail_windows", "&Edit", nullptr));
        mnuHelp->setTitle(QCoreApplication::translate("win_snail_windows", "&Help", nullptr));
        menuMachine->setTitle(QCoreApplication::translate("win_snail_windows", "&Machine", nullptr));
        (void)win_snail_windows;
    } // retranslateUi

};

namespace Ui {
    class win_snail_windows: public Ui_win_snail_windows {};
} // namespace Ui
