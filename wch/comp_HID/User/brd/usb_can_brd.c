...
////    GPIO_InitStructure.GPIO_Speed = GPIO_Speed_50MHz;
    ...
    GPIO_InitStructure.GPIO_Mode = GPIO_Mode_Out_PP;
    GPIO_InitStructure.GPIO_Speed = GPIO_Speed_50MHz;
    GPIO_Init(RLED_GPIO, &GPIO_InitStructure);
    ////============= CAN ==================================
   ...
   ////============= INH ==================================
    ...
    ////============= X_TMS ==================================
    GPIO_InitStructure.GPIO_Pin = X_TMS_PIN;
    GPIO_InitStructure.GPIO_Mode = GPIO_Mode_Out_PP;
    GPIO_InitStructure.GPIO_Speed = GPIO_Speed_50MHz;
    GPIO_Init(X_TMS_GPIO, &GPIO_InitStructure);
#if 0
    ////=============tst1 ==================================
...
*/
///=============== led =======================================
void set_rled(uint8_t on_off)
{
 if(on_off&0x1)
     GPIO_WriteBit(RLED_GPIO,RLED_PIN,Bit_SET);
 else
     GPIO_WriteBit(RLED_GPIO,RLED_PIN, Bit_RESET);
}
///=============== tst1 =======================================
#if 0
