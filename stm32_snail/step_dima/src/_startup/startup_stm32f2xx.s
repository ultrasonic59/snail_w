...
__vector_table
        ...
        DCD     FLASH_IRQHandler                  ; FLASH       20                                    
        DCD     RCC_IRQHandler                  ; RCC                                             
 ;//       DCD     EXTI0_irq                       ;EXTI0_IRQHandler                  ; EXTI Line0                                             
 ;//       DCD     EXTI1_irq                       ;EXTI1_IRQHandler                  ; EXTI Line1                                             
 ;//       DCD     EXTI2_irq                       ;EXTI2_IRQHandler                  ; EXTI Line2                                             
 ;//       DCD     EXTI3_irq                       ;EXTI3_IRQHandler                  ; EXTI Line3                                             
 ;//       DCD     EXTI4_irq                       ;EXTI4_IRQHandler                  ; EXTI Line4                                             
        ...
        DCD     DMA1_Stream3_IRQHandler           ; DMA1 Stream 3       30                            
        ...
        DCD     TIM1_BRK_TIM9_IRQHandler          ; TIM1 Break and TIM9      40             
        ...
        DCD     I2C2_ER_IRQHandler                ; I2C2 Error                          50                                  
        ...
        DCD     TIM8_UP_TIM13_IRQHandler          ; TIM8 Update and TIM13               60             
        DCD     TIM8_TRG_COM_TIM14_IRQHandler     ; TIM8 Trigger and Commutation and TIM14
        DCD     TIM8_CC_IRQHandler                ; TIM8 Capture Compare                                   
        DCD     DMA1_Stream7_IRQHandler           ; DMA1 Stream7                                           
        DCD     FSMC_IRQHandler                   ; FSMC                                            
        DCD     SDIO_IRQHandler                   ; SDIO                        65                                          
        DCD     TIM5_IRQHandler                   ; TIM5                                            
        DCD     SPI3_IRQHandler                   ; SPI3                                            
        DCD     UART4_IRQHandler                  ; UART4                       68                    
        DCD     UART5_IRQHandler                  ; UART5                                           
        DCD     TIM6_DAC_IRQHandler               ; TIM6 and DAC1&2 underrun errors    70               
        DCD     TIM7_irq                        ;TIM7_IRQHandler                   ; TIM7                   
        DCD     DMA2_Stream0_IRQHandler           ; DMA2 Stream 0                                   
        DCD     DMA2_Stream1_IRQHandler           ; DMA2 Stream 1                                   
        DCD     DMA2_Stream2_IRQHandler           ; DMA2 Stream 2                                   
        DCD     DMA2_Stream3_IRQHandler           ; DMA2 Stream 3    75                               
