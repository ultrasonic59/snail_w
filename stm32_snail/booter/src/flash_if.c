...
{
uint32_t UserStartSector = ADDR_FLASH_SECTOR_4;
uint32_t UserEndSector = ADDR_FLASH_SECTOR_11;
...
uint32_t i = 0;
  ...
  if(UserEndSector<ADDR_FLASH_SECTOR_11)
    UserEndSector++;
...
/**
  ...
  */
uint32_t FLASH_If_DisableWriteProtection(uint32_t StartAddr)
{
