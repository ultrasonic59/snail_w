...
////============= DPX ========================
////============= DPX_RA ========================
#define DPX_RA_PIN	    	GPIO_Pin_0
#define DPX_RA_PIN_NPIN	    	0
#define DPX_RA_GPIO             GPIOA
#define DPX_RA_RCC  	        RCC_AHB1Periph_GPIOA
#define DPX_RA_AF               GPIO_AF_TIM5
#define DPX_R_TIM               TIM5
#define DPX_R_TIM_RCC           RCC_APB1Periph_TIM5
////============= DPX_RB ========================
#define DPX_RB_PIN	    	GPIO_Pin_1
#define DPX_RB_PIN_NPIN	    	1
#define DPX_RB_GPIO             GPIOA
#define DPX_RB_RCC  	        RCC_AHB1Periph_GPIOA
#define DPX_RB_AF               GPIO_AF_TIM5
////============= DPX_R0 ========================
...
////============= DPX_LA ========================
#define DPX_LA_PIN	    	GPIO_Pin_8
#define DPX_LA_PIN_NPIN	    	8
#define DPX_LA_GPIO             GPIOA
#define DPX_LA_RCC  	        RCC_AHB1Periph_GPIOA
#define DPX_LA_AF               GPIO_AF_TIM1
#define DPX_L_TIM               TIM1
#define DPX_L_TIM_RCC           RCC_APB2Periph_TIM1
////============= DPX_LB ========================
#define DPX_LB_PIN	    	GPIO_Pin_9
#define DPX_LB_PIN_NPIN	    	9
#define DPX_LB_GPIO             GPIOA
#define DPX_LB_RCC  	        RCC_AHB1Periph_GPIOA
#define DPX_LB_AF               GPIO_AF_TIM1
////==============================================
////==============DPY===========================
////============= DPY_RA ========================
#define DPY_RA_PIN	    	GPIO_Pin_4
#define DPY_RA_PIN_NPIN	    	4
...
////============= DPY_RB ========================
#define DPY_RB_PIN	    	GPIO_Pin_5
#define DPY_RB_PIN_NPIN	    	5
...
////============= DPY_LA ========================
#define DPY_LA_PIN	    	GPIO_Pin_6
#define DPY_LA_PIN_NPIN	    	6
...
////============= DPY_LB ========================
#define DPY_LB_PIN	    	GPIO_Pin_7
#define DPY_LB_PIN_NPIN	    	7
