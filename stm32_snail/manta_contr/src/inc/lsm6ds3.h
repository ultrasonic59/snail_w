...
#define LSM6DS3_I2C_ADDRESS 					0x6A ////(0x6A << 1)
...
#define	LSM6DS3_OK                      0
#define	LSM6DS3_FAIL                    -1
#define	LSM6DS3_FAIL_PARAMETERS         -2
#define	LSM6DS3_FAIL_COMPARE 	        -3

#if 0
////void LSM6DS3_Initialize(uint8_t SA0, uint16_t timeout, I2C_HandleTypeDef* i2c_channel);
LSM6DS3_Result LSM6DS3_Detect(void);
