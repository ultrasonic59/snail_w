...
#define STEP_MASK       (X_STEP_BIT_DEF|Y_STEP_BIT_DEF|Z_STEP_BIT_DEF)
...
#define DIRECTION_MASK    (X_DIRECTION_BIT_DEF|Y_DIRECTION_BIT_DEF|Z_DIRECTION_BIT_DEF)
...
#define LIMIT_MASK       (LIMIT_X_BIT_DEF|LIMIT_Y_BIT_DEF|LIMIT_Z_BIT_DEF)
