...
private:
	...
	void SetRefferenceAlign();
	void ApplyRefferenceAlign();


	void SetRefferenceAlignMode();
	void ApplyRefferenceAlignMode();
	...
	// Align
	QVector3D m_reference_align;
	int refference_align_move;
