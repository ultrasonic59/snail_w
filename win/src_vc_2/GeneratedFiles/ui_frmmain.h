...
public:
    ...
    QLineEdit *txtStartPosX;
    QLineEdit *txtStartPosY;
    QLineEdit *txtStartPosZ;
    QHBoxLayout *horizontalLayout_33;
    QRadioButton *radio_no_move;
    QRadioButton *radio_to_XY;
    QRadioButton *radio_to_XYZ;
    QToolButton *cmdSetOrigin;
    QFrame *line;
...
"padding-right: 8;"));
        ...
        grpAlign = new QGroupBox(centralWidget);
        grpAlign->setObjectName(QStringLiteral("grpAlign"));
        grpAlign->setFont(font);
        horizontalLayout_32 = new QHBoxLayout(grpAlign);
        horizontalLayout_32->setSpacing(6);
        horizontalLayout_32->setContentsMargins(11, 11, 11, 11);
        horizontalLayout_32->setObjectName(QStringLiteral("horizontalLayout_32"));
        horizontalLayout_32->setContentsMargins(8, 0, 8, 5);
        ...
        txtStartPosX = new QLineEdit(grpAlign);
        txtStartPosX->setObjectName(QStringLiteral("txtStartPosX"));
        txtStartPosX->setMinimumSize(QSize(0, 30));
        txtStartPosX->setFont(font);
        txtStartPosX->setAlignment(Qt::AlignCenter);

        horizontalLayout_17->addWidget(txtStartPosX);

        txtStartPosY = new QLineEdit(grpAlign);
        txtStartPosY->setObjectName(QStringLiteral("txtStartPosY"));
        txtStartPosY->setMinimumSize(QSize(0, 30));
        txtStartPosY->setFont(font);
        txtStartPosY->setAlignment(Qt::AlignCenter);

        horizontalLayout_17->addWidget(txtStartPosY);

        txtStartPosZ = new QLineEdit(grpAlign);
        txtStartPosZ->setObjectName(QStringLiteral("txtStartPosZ"));
        txtStartPosZ->setMinimumSize(QSize(0, 30));
        txtStartPosZ->setFont(font);
        txtStartPosZ->setAlignment(Qt::AlignCenter);

        horizontalLayout_17->addWidget(txtStartPosZ);
        ...
        radio_no_move = new QRadioButton(grpAlign);
        radio_no_move->setObjectName(QStringLiteral("radio_no_move"));
        radio_no_move->setFont(font);

        horizontalLayout_33->addWidget(radio_no_move);

        radio_to_XY = new QRadioButton(grpAlign);
        radio_to_XY->setObjectName(QStringLiteral("radio_to_XY"));
        radio_to_XY->setFont(font);

        horizontalLayout_33->addWidget(radio_to_XY);

        radio_to_XYZ = new QRadioButton(grpAlign);
        radio_to_XYZ->setObjectName(QStringLiteral("radio_to_XYZ"));
        radio_to_XYZ->setFont(font);

        horizontalLayout_33->addWidget(radio_to_XYZ);
        ...
        cmdSetOrigin = new QToolButton(grpAlign);
        cmdSetOrigin->setObjectName(QStringLiteral("cmdSetOrigin"));
        cmdSetOrigin->setMinimumSize(QSize(54, 54));
        cmdSetOrigin->setIcon(icon14);
        cmdSetOrigin->setIconSize(QSize(30, 30));
        cmdSetOrigin->setToolButtonStyle(Qt::ToolButtonTextUnderIcon);

        horizontalLayout_32->addWidget(cmdSetOrigin);


        verticalLayout_2->addWidget(grpAlign);
...
"}"));
    ...
    void retranslateUi(QMainWindow *frmMain)
    {
        ...
        grpAlign->setTitle(QApplication::translate("frmMain", "Align origins", 0));
#ifndef QT_NO_TOOLTIP
        txtStartPosX->setToolTip(QApplication::translate("frmMain", "X", 0));
#endif // QT_NO_TOOLTIP
        txtStartPosX->setText(QApplication::translate("frmMain", "0", 0));
#ifndef QT_NO_TOOLTIP
        txtStartPosY->setToolTip(QApplication::translate("frmMain", "Y", 0));
#endif // QT_NO_TOOLTIP
        txtStartPosY->setText(QApplication::translate("frmMain", "0", 0));
#ifndef QT_NO_TOOLTIP
        txtStartPosZ->setToolTip(QApplication::translate("frmMain", "Z", 0));
#endif // QT_NO_TOOLTIP
        txtStartPosZ->setText(QApplication::translate("frmMain", "0", 0));
        radio_no_move->setText(QApplication::translate("frmMain", "No move", 0));
        radio_to_XY->setText(QApplication::translate("frmMain", "To X0 Y0", 0));
        radio_to_XYZ->setText(QApplication::translate("frmMain", "To X0 Y0 Z0", 0));
        cmdSetOrigin->setText(QApplication::translate("frmMain", "Align", 0));
