...
void frmMain::loadSettings()
{
	...
	m_reference_align.setX(set.value("refference_alignX", 0.0f).toFloat());
	m_reference_align.setY(set.value("refference_alignY", 0.0f).toFloat());
	m_reference_align.setZ(set.value("refference_alignZ", 0.0f).toFloat());
	SetRefferenceAlign();

	refference_align_move = set.value("refference_align_move", 0).toInt();
	SetRefferenceAlignMode();
...
void frmMain::saveSettings()
{
    ...
    set.setValue("refference_alignX", m_reference_align.x());
    set.setValue("refference_alignY", m_reference_align.y());
    set.setValue("refference_alignZ", m_reference_align.z());


	ApplyRefferenceAlignMode();
	set.setValue("refference_align_move", refference_align_move);
