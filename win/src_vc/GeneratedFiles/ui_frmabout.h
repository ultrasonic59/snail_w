...
"}"));
        ...
        frame->setStyleSheet(QStringLiteral("image: url(:/images/icon3png.png);"));
    ...
    void retranslateUi(QDialog *frmAbout)
    {
        ...
        lblAbout->setText(QApplication::translate("frmAbout", "<html><head/><body><p>grblControl<br/>Version: %1<br/>License: GNU GENERAL PUBLIC LICENSE<br/>Visit: <a href=\"https://github.com/Denvi/grblControl/\"><span style=\" text-decoration: underline; color:#0000ff;\">https://github.com/Denvi/grblControl/<br/></span></a>\302\251 2015 Hayrullin Denis Ravilevich</p></body></html>", 0));
