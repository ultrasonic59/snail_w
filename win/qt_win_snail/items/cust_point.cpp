...
QPointF cust_point::previousPosition() const
{
    return m_previousPosition;
}

void cust_point::setPreviousPosition(const QPointF previousPosition)
{
...
void cust_point::setRect(qreal x, qreal y, qreal w, qreal h)
{
   setRect(QRectF(x,y,w,h));
}
void cust_point::setCircle(qreal x, qreal y, qreal d)
{
    setRect(QRectF(x, y, d, d));
}

void cust_point::setRect(const QRectF &rect)
{
#if 1
...
void cust_point::mouseReleaseEvent(QGraphicsSceneMouseEvent *event)
{
    if (event->button() & Qt::LeftButton) {
...
void cust_point::hoverEnterEvent(QGraphicsSceneHoverEvent *event)
{
    setPositionGrabbers();
    setVisibilityGrabbers();
...
void cust_point::hoverLeaveEvent(QGraphicsSceneHoverEvent *event)
{
    m_cornerFlags = 0;
    hideGrabbers();
...
void cust_point::hoverMoveEvent(QGraphicsSceneHoverEvent *event)
{
...
QVariant cust_point::itemChange(QGraphicsItem::GraphicsItemChange change, const QVariant &value)
{
    switch (change) {
...
void cust_point::resizeLeft(const QPointF &pt)
{
    QRectF tmpRect = rect();
...
void cust_point::resizeRight(const QPointF &pt)
{
    QRectF tmpRect = rect();
...
void cust_point::resizeBottom(const QPointF &pt)
{
    QRectF tmpRect = rect();
    if( pt.y() < tmpRect.top() )
        return;
...
void cust_point::resizeTop(const QPointF &pt)
{
    QRectF tmpRect = rect();
