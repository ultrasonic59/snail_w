...
public:
    ...
    QAction *actionProj;
    QAction *actionFile;
    QAction *actionProj_2;
    QAction *actionFile_2;
    ...
    QPushButton *buttConHid;
    QSlider *lightSlider;
    QPushButton *buttConCAN;
    QMenuBar *menuBar;
    QMenu *mnuFile;
    QMenu *mnuRecent;
    QMenu *menu_New;
    ...
    void setupUi(QMainWindow *win_snail)
    {
        ...
        actionProj = new QAction(win_snail);
        actionProj->setObjectName(QString::fromUtf8("actionProj"));
        actionFile = new QAction(win_snail);
        actionFile->setObjectName(QString::fromUtf8("actionFile"));
        actionProj_2 = new QAction(win_snail);
        actionProj_2->setObjectName(QString::fromUtf8("actionProj_2"));
        actionFile_2 = new QAction(win_snail);
        actionFile_2->setObjectName(QString::fromUtf8("actionFile_2"));
        ...
        buttDebug->setGeometry(QRect(590, 0, 41, 23));
        buttConHid = new QPushButton(centralWidget);
        buttConHid->setObjectName(QString::fromUtf8("buttConHid"));
        buttConHid->setGeometry(QRect(700, 0, 71, 23));
        ...
        lightSlider->setMaximum(999);
        lightSlider->setOrientation(Qt::Horizontal);
        buttConCAN = new QPushButton(centralWidget);
        buttConCAN->setObjectName(QString::fromUtf8("buttConCAN"));
        buttConCAN->setGeometry(QRect(640, 0, 61, 23));
        ...
        menu_New = new QMenu(mnuFile);
        menu_New->setObjectName(QString::fromUtf8("menu_New"));
        menu_Open = new QMenu(mnuFile);
        ...
        mnuFile->addAction(menu_New->menuAction());
        mnuFile->addAction(menu_Open->menuAction());
        ...
        menu_New->addAction(actionProj);
        menu_New->addAction(actionFile);
        menu_Open->addAction(actionProj_2);
        menu_Open->addAction(actionFile_2);
    ...
    void retranslateUi(QMainWindow *win_snail)
    {
        ...
        actionProj->setText(QCoreApplication::translate("win_snail", "Proj", nullptr));
        actionFile->setText(QCoreApplication::translate("win_snail", "File", nullptr));
        actionProj_2->setText(QCoreApplication::translate("win_snail", "Proj", nullptr));
        actionFile_2->setText(QCoreApplication::translate("win_snail", "File", nullptr));
#if QT_CONFIG(tooltip)
        ...
        buttConHid->setText(QCoreApplication::translate("win_snail", "ConHid", nullptr));
        buttConCAN->setText(QCoreApplication::translate("win_snail", "ConCAN", nullptr));
        ...
        menu_New->setTitle(QCoreApplication::translate("win_snail", "&New", nullptr));
        menu_Open->setTitle(QCoreApplication::translate("win_snail", "&Open", nullptr));
