...
"}"));
        ...
        lblAbout->setTextFormat(Qt::AutoText);
    ...
    void retranslateUi(QDialog *frmAbout)
    {
        ...
        lblAbout->setText(QCoreApplication::translate("frmAbout", "<html><head><title>About</title></head><body><p>Candle 2<br/>Version: 2.6<br/>License: GNU GENERAL PUBLIC LICENSE<br/>\302\251 2015-2016 Hayrullin Denis Ravilevich<br/>\302\251 2018-2024 Patrick F.</p><p>Visit: <a href=\"https://github.com/Schildkroet/Candle2/\"><span style=\" text-decoration: underline; color:#0000ff;\">https://github.com/Schildkroet/Candle2/</span></a></p></body></html>", nullptr));
