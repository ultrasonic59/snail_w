...
void GLWidget::paintEvent(QPaintEvent *pe) {
 ...
 ////   int width = fm.width(str);
    ...
    painter.drawText(QPoint(this->width() - width - 10, y + 30), str);
    str = QString("FPS: %1").arg(m_fps);
    width = fm.horizontalAdvance(str);
    painter.drawText(QPoint(this->width() - width - 10, y + 45), str);

    str = m_spendTime.toString("hh:mm:ss") + " / " + m_estimatedTime.toString("hh:mm:ss");
    width = fm.horizontalAdvance(str);
    painter.drawText(QPoint(this->width() - width - 10, y), str);

    str = m_bufferState;
    width = fm.horizontalAdvance(str);
    painter.drawText(QPoint(this->width() - width - 10, y + 15), str);
