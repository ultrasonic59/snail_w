...
////============= PWM_LED0 ==================================
  #define PWM_LED0_PIN          GPIO_Pin_7
  #define PWM_LED0_GPIO         GPIOC
  #define TIM_PWM              TIM8
  #define TIM_PWM_LED0_CH      CH2CVR
////============= PWM_LED1 ==================================
  #define PWM_LED1_PIN          GPIO_Pin_6
  #define PWM_LED1_GPIO         GPIOC
  #define TIM_PWM              TIM8
  #define TIM_PWM_LED1_CH      CH1CVR
////============= ON_DV ==================================
...
////============= INH ==================================
  #define INH_PIN          GPIO_Pin_14
  #define INH_GPIO         GPIOB
////=============led ==================================
